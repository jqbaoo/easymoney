...
**上表 14 项全部未做**，等 Unity 里点 Play 走一遍再回来填结果。对应的提交见
`feat: 报表新增环形图视图，用下拉浮层切换`。EditMode 那边 335 个用例全绿，但
**测试全绿不代表界面验过**——这一版新增的界面部分里，只有「建了什么节点、
切视图有没有清场、回调有没有触发」是测试能给的，位置、观感、清晰度都在上表里。
